...
public record struct Collider(float Width, float Height, Vector2 Pivot,
    ...
    Action<Entity, MouseButton, List<Modifiers>> OnMouseUp = null,
    Action<Entity, MouseButton, List<Modifiers>> OnMousePressed = null,
    Action<Entity, MouseButton, List<Modifiers>> OnMouseDown = null,
